...
struct State {
    ...
    mouse_pressed: bool,
    world: world::World,
    world_pipeline: world::WorldPipeline,
}
...
impl State {
    async fn new(
        ...
        let light = Light::new(&device, &camera_bind_group_layout, &config);
...
fn init_debug_material(
    ...
    let debug_material = {
        ...
        .unwrap();
        let normal_texture =
            texture::Texture::from_bytes(&device, &queue, normal_bytes, "res/alt-normal.png", true)
                .unwrap();
